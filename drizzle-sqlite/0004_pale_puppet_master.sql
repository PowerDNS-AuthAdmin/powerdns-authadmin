...
-- #85 — wipe provider-derived rows from role_assignments BEFORE the table-
-- recreate dance below. Otherwise the INSERT...SELECT would carry them over
-- with their provider_id stripped, leaving stale grants that look admin-
-- issued. Affected users re-materialise their permissions into the new
